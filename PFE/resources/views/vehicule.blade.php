...
<div class="my-3 p-3 bg-body rounded shadow-sm">
        <h6 class="border-bottom pb-2 mb-4 "> Liste des véhicules</h6>

        <div class="mt-4">
            <div class="d-flex justify-content-end mt-4">

            <a href="" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#modalRegistrar"> Nouvau véhicule</a>
            </div>
...
<div class="modal fade" id="modalRegistrar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form style="width:65% " method="post" action="{{route('vehicules.create')}}" >
        @csrf
  <div class="mb-3">
  ...
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Modéle</label>
  ...
  <button type="submit" class="btn text-success"><i class="fas fa-plus"></i>Ajouter</button>
  <a href="{{route('vehicules')}}" class="btn text-danger"><i class="fas fa-arrow-left"></i> Retour</a>
  ...
  <tbody>
    ...
    <tr>
      ...
      <a href="forceDelete1/{{$vehicule->id}}" class="text-danger btn"><i class="fa fa-solid fa-trash"></i> </a>



      <!-- <a href="/delete-vehicule/{{ $vehicule->id }}" class="btn btn-danger">Supprimer</a> -->
     </td>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Modifier les infos du vehicule</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">

      <form style="width:65% " method="post" action="/update/traitement" >
        @csrf
        <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">id</label>
        <input type="text" class="form-control" name="id"  value="{{$vehicule->id}}">
        </div>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Marque</label>
  ...
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Statut</label>
    <input type="text" class="form-control" name="statut" value="{{$vehicule->statut}}">
  </div>
