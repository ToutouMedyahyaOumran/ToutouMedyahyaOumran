        ...
        <br>
         <!-- With actions -->
            ...
            <div class="d-flex justify-content-end mt-4">
              <form  class="d-flex ml-0 mb-1"  type="get" action="{{ url('/searchsu') }}">
...
@endif
              <!-- w-full -->
              <!-- <div
                class="relative    focus-within:text-purple-500 "
              >
                <div class="absolute inset-y-0 flex items-center pl-2 ">
                  <svg
                    class="w-4 h-4"
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Ajouter support</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <form action="{{route('sp.create')}}" method="post" >
        @csrf
      <div class="mb-3">
...
<!-- 
  ...
  <!-- <div class="modal-footer"> -->
   ...
   <div class="modal-header">
   <button class="btn btn-primary btn-sm"  data-bs-toggle="modal" data-bs-target="#modalRegistrar">Ajouter support</button>
   </div>
                ...
                <table class="w-full whitespace-no-wrap">
                  ...
                  <tr>
                      ...
                      <td>
                        ...
                        <a href="{{route('sp.delete',$item->id)}}" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash"></i></i></a>
                      </td>
...
<div class="modal fade" id="exampleModal{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Modifier support</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
    ...
    <label for="exampleInputEmail1" class="form-label">Email address</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="email" value="{{$item->email}}">
    ...
    <label for="exampleInputEmail1" class="form-label">role</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="role" value="{{$item->admin_id}}">
    <br>
